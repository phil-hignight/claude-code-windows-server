...
class ClaudeCodeRunner {
  ...
  async startAsModule() {
    ...
    try {
      ...
      // Don't change working directory to Windows path (Linux can't chdir to Windows path)
      // The Windows CWD will be passed via system message instead
      ...
      try {
        ...
        // Don't restore CWD since we didn't change it
      }
